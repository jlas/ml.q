...
nextpaths:{[data;n_]
 ...
 clause:{if[1=count x;:first x]; {((';,);x;y)} over x}[n_];
 ...
 (,/){[newp;x] {`n_`v_!(y;x[`v_])}[x;] each newp }[newp;] each tmp}
...
id3hlpr:{[data;tree;l]
 ...
 if[l=count attrs;:r];
 / recurse
 id3hlpr[data;(,/) nextpaths[data] each r`n_;l+1]}
